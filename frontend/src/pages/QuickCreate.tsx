...
//         e.preventDefault()
//         setDragOver(false)
//         const newFiles = Array.from(e.dataTransfer.files).map((file) => ({ file, uploading: true }))
//         setFiles((prev) => [...prev, ...newFiles])
//         setTimeout(() => setFiles((prev) => prev.map((f) => ({ ...f, uploading: false }))), 1500)
//     }
...
//     }
//     const handleAddFromOneDrive = () => {
//         // TODO: implement OneDrive picker
//         console.log("Add from Microsoft OneDrive")
//     }

//     const removeFile = (name: string) => setFiles((prev) => prev.filter((f) => f.file.name !== name))
//     const getFileIcon = (typeOrName: string) => {
//         if (typeOrName.includes("pdf")) return <FileText className="text-pink-500" />
//         if (typeOrName.match(/\.(js|ts|jsx|tsx)$/)) return <FileCode className="text-blue-500" />
...
//         try {
//             await fetch("/api/sendMessage", { method: "POST", body: formData })
...
//                             <div key={file.name} className="flex items-center justify-between bg-gray-100 px-3 py-2 rounded-md">
...
//                                         <img src={filePlusLogo} alt="File Plus" className="mr-2 w-5 h-5" /> Upload a file
//                                     </DropdownMenuItem>
//                                     <DropdownMenuItem onClick={handleAddFromGoogle}>
//                                         <img src={googleDriveLogo} alt="Google Drive" className="mr-2 w-5 h-5" /> Add from Google Drive
//                                     </DropdownMenuItem>
//                                     <DropdownMenuItem onClick={handleAddFromOneDrive}>
//                                         <img src={oneDriveLogo} alt="OneDrive" className="mr-2 w-5 h-5" /> Add from Microsoft OneDrive
//                                     </DropdownMenuItem>
//                                 </DropdownMenuContent>
//                             </DropdownMenu>
//                             <DropdownMenu>
...
//                                 <DropdownMenuContent>
//                                     <DropdownMenuItem onClick={handleUploadClick}>
//                                         <img src={filePlusLogo} alt="File Plus" className="mr-2 w-5 h-5" /> Tool 1
//                                     </DropdownMenuItem>
//                                     <DropdownMenuItem onClick={handleAddFromGoogle}>
//                                         <img src={googleDriveLogo} alt="Google Drive" className="mr-2 w-5 h-5" /> Tool 2
//                                     </DropdownMenuItem>
//                                     <DropdownMenuItem onClick={handleAddFromOneDrive}>
//                                         <img src={oneDriveLogo} alt="OneDrive" className="mr-2 w-5 h-5" /> Tool 3
//                                     </DropdownMenuItem>
//                                 </DropdownMenuContent>
//                             </DropdownMenu>
...
//                                         <DropdownMenuItem key={opt.label} onClick={() => setSelectedModel(opt.label)}>
//                                             <div className="flex justify-between items-center w-full">
//                                                 <div>
//                                                     <div>{opt.label}</div>
//                                                     <div className="text-xs text-muted-foreground">{opt.desc}</div>
//                                                 </div>
//                                                 {selectedModel === opt.label && <Check className="w-4 h-4 text-blue-500" />}
//                                             </div>
//                                         </DropdownMenuItem>
//                                     ))}
